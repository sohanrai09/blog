...
- robotframework
---
It's been a while since my first [blog post](https://sohanrai09.github.io/blog/posts/robotframework-1/) as I mentioned there, I'm at a new job (well it's been 2 months, so 'newish') and I've been busy getting to know the job(as with any job, there is a LOT to learn!).
...
In this post, I will only explain anything new I'm using in RF as compared to my first [blog post](https://sohanrai09.github.io/blog/posts/robotframework-1/).
